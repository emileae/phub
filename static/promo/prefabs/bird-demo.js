...
Game.BirdDemo = function(game, x, y, frame) {
...
Game.BirdDemo.prototype = Object.create(Phaser.Sprite.prototype);
Game.BirdDemo.prototype.constructor = Game.BirdDemo;

Game.BirdDemo.prototype.update = function() {
  if(this.alive) {
...
Game.BirdDemo.prototype.flap = function() {
...
Game.BirdDemo.prototype.revived = function() {
